...
class FakeAttributeContainerStoreTest(test_lib.BaseTestCase):
    ...
    def testGetAttributeContainers(self):
        ...
        containers = list(
            test_store.GetAttributeContainers(attribute_container.CONTAINER_TYPE)
        )
        ...
        containers = list(
            test_store.GetAttributeContainers(
                attribute_container.CONTAINER_TYPE, filter_expression=filter_expression
            )
        )
        self.assertEqual(len(containers), 1)
    ...
    def testHasAttributeContainers(self):
        ...
        result = test_store.HasAttributeContainers(attribute_container.CONTAINER_TYPE)
